    ...
    inner class ViewHolder() : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: ResponseRecipes.Result) {
            binding.apply {
                ...
                val htmlFormatter = HtmlCompat.fromHtml(item.summary.toString(), HtmlCompat.FROM_HTML_MODE_COMPACT)
                ...
                recipeHealthTxt.text = item.healthScore?.toInt().toString()
                //Image
                ...
                val score = item.healthScore ?: return
